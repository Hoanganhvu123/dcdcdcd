...
DEFAULT_SYSTEM_PROMPT = BASE_AGENT_PROMPT
...
def get_default_model() -> ChatAnthropic:
    ...
    Returns:
        ChatAnthropic instance configured with a reasonable default.
    """
    # Keep it minimal to avoid signature drift issues across versions
    from dbgpt_analyst.common.llm_factory import preferred_model_name
    return ChatAnthropic(model=preferred_model_name())
