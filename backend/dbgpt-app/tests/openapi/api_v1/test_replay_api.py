"""backend/dbgpt-app/tests/openapi/api_v1/test_replay_api.py

Comprehensive test suite for DB-GPT Replay Subsystem & Presentation Deck Generation:
1. Replay Sessions List & Pagination / Filtering
2. Replay Session Detail Retrieval & 404 Error Handling
3. Replay SSE Wire Streaming Protocol & Event Sequences
4. Deck Generation via /api/v1/analyst/deck/generate and /api/v1/replay/deck/generate
5. Mathematical Groundedness & Presentation Binary (.pptx) Validation
"""
import base64
import io
import json
