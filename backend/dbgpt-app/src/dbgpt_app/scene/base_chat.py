...
class BaseChat(ABC):
    ...
    async def stream_call(
        ...
        span.metadata["user_id"] = self._chat_param.user_name
        span.metadata["conversation_id"] = self.chat_session_id
        span.metadata["chat_scene"] = self.chat_mode.value()
        span.metadata["model_name"] = self.llm_model
        span.metadata["service"] = "dbgpt"
