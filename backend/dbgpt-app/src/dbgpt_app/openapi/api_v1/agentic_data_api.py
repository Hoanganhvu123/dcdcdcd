...
from dbgpt.util.tracer.langfuse_client import get_langfuse_decorator_for_system
...
_obs = get_langfuse_decorator_for_system(CFG.SYSTEM_APP)
if _obs:
    _react_agent_stream = _obs()(_react_agent_stream)
