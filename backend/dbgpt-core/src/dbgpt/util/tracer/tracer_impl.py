...
class TracerParameters(BaseParameters):
    ...
    langfuse_public_key: Optional[str] = field(
        ...
        metadata={
            "help": _(
                "Langfuse public key, you can set "
                "'${env:LANGFUSE_PUBLIC_KEY}' to use the environment variable"
            ),
        },
    )
    langfuse_secret_key: Optional[str] = field(
        ...
        metadata={
            "help": _(
                "Langfuse secret key, you can set "
                "'${env:LANGFUSE_SECRET_KEY}' to use the environment variable"
            ),
        },
    )
    langfuse_host: Optional[str] = field(
        ...
        metadata={
            "help": _(
                "Langfuse host URL, you can set "
                "'${env:LANGFUSE_HOST}' to use the environment variable"
            ),
        },
    )
    ...
    def __post_init__(self):
        ...
        if self.langfuse_host is None or self.langfuse_host == "https://cloud.langfuse.com":
...
def initialize_tracer(
    ...
    telemetry_on = bool(
        tracer_parameters and tracer_parameters.exporter == "telemetry"
    )
    langfuse_on = bool(tracer_parameters and tracer_parameters.langfuse_enabled)
    if telemetry_on or langfuse_on:
        ...
        storage_container.append_storage(
            OpenTelemetrySpanStorage(
                ...
                otlp_enabled=telemetry_on,
                langfuse_public_key=tracer_parameters.langfuse_public_key,
                langfuse_secret_key=tracer_parameters.langfuse_secret_key,
                langfuse_host=tracer_parameters.langfuse_host,
            )
        )
