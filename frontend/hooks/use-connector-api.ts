...
export function useConnectorTypes() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch(err => console.debug('Failed to fetch connector types:', err))
...
export function useConnectors() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch(err => console.debug('Failed to fetch connectors:', err))
      .finally(() => setLoading(false));
  }, [version]);
...
export function useCreateConnector() {
  ...
  const create = useCallback(async (data: CreateConnectorRequest): Promise<ConnectorInstance> => {
    ...
    try {
      ...
      console.debug('Failed to create connector:', err);
      throw err;
    } finally {
      setLoading(false);
    }
...
export function useUpdateConnector() {
  ...
  const update = useCallback(async (id: string, data: Partial<CreateConnectorRequest>): Promise<ConnectorInstance> => {
    ...
    try {
      ...
      console.debug('Failed to update connector:', err);
      throw err;
    } finally {
      setLoading(false);
    }
...
export function useDeleteConnector() {
  ...
  const remove = useCallback(async (id: string): Promise<void> => {
    ...
    try {
      ...
      console.debug('Failed to delete connector:', err);
      throw err;
    } finally {
      setLoading(false);
    }
...
export function useConnectorTools(connectorId?: string) {
  ...
  const fetchTools = useCallback(async () => {
    ...
    try {
      ...
      console.debug('Failed to fetch connector tools:', err);
