export const CommonEn = {
  ...
  model_last_heart_beat: 'Last Heart Beat',
  ...
  // -- Share replay page --
  'share.section.analysis': 'Analysis & planning',
  'share.section.skill': 'Skill loading',
  'share.section.execution': 'Data processing & execution',
  'share.section.process': 'Execution process',
  'share.error.invalid': 'Share link is invalid or has expired',
  'share.error.invalidWithStatus': 'Share link is invalid or has expired ({{status}})',
  'share.error.badFormat': 'Malformed data',
  'share.error.loadFailed': 'Load failed',
  'share.error.noContent': 'No conversation content to replay',
  'share.msg.linkCopied': 'Link copied',
  'share.loading': 'Loading...',
  'share.title.withQuestion': '{{question}} - DB-GPT replay',
  'share.title.default': 'DB-GPT conversation replay',
  'share.badge.replay': 'Replay',
  'share.btn.restart': 'Replay again',
  'share.btn.pause': 'Pause',
  'share.btn.start': 'Start replay',
  'share.btn.resume': 'Resume',
  'share.btn.share': 'Share',
  'share.tip.skipToEnd': 'Skip to last step',
  'share.tip.copyLink': 'Copy share link - anyone with it can replay this conversation',
  'share.progress.steps': '{{done}} / {{total}} steps',
  'share.round.n': 'Round {{n}}',
  'share.round.pending': '{{count}} rounds left to replay...',
  // -- Generic --
  ...
  // -- Evaluation page --
  'eval.col.code': 'Code',
  'eval.col.storage': 'Storage type',
  'eval.col.datasetCount': 'Datasets',
  'eval.col.datasetName': 'Dataset name',
  'eval.col.status': 'Status',
  'eval.col.evalCode': 'Evaluation code',
  'eval.col.metrics': 'Metrics',
  'eval.col.result': 'Result',
  'eval.tip.viewLogs': 'View logs and scores',
  'eval.btn.scoreDetail': 'Score details',
  'eval.tab.data': 'Evaluation data',
  'eval.tab.dataset': 'Datasets',
  'eval.btn.addDataset': 'Add dataset',
  'eval.btn.editDataset': 'Edit dataset',
  'eval.btn.start': 'Start evaluation',
  'eval.modal.startTitle': 'Start evaluation',
  'eval.msg.startSuccess': 'Evaluation started',
  'eval.form.sceneType': 'Scene type',
  'eval.form.sceneValue': 'Scene parameter',
  'eval.form.parallel': 'Parallelism',
  'eval.form.datasets': 'Datasets',
  'eval.form.metrics': 'Metrics',
  'eval.form.storageType': 'Storage type',
  'eval.modal.scoreDetail': 'Score details',
  // -- Recall test modal --
  recall_config: 'Recall configuration',
  vector_retrieval_settings: 'Vector retrieval settings',
  topk_tooltip: 'Top k vectors by similarity score',
  recall_method: 'Recall method',
  score_threshold: 'Score threshold',
  test_question: 'Test question',
  please_input_test_question: 'Please enter a test question',
  test: 'Test',
  ...
  admin_ids_label: 'Administrators (employee ID, drop leading zeros):',
  title_label: 'Title',
  value_label: 'Value',
  param_name_label: 'Parameter {{index}} name',
  param_name_rule: 'Name must contain only letters, digits or underscores, using underscores to separate words',
  header_json_invalid: 'Header format is invalid, please enter valid JSON',
  response_mapping_json_invalid: 'Response Mapping format is invalid, please enter valid JSON',
  feedback_drawer_title: 'Your feedback helps us improve',
  feedback_placeholder: 'Describe the issue or a better answer',
  thinking: 'Thinking',
  // -- Status & upload --
  ...
  collapse: 'Collapse',
  expand: 'Expand',
  related_question_label: 'Related question:',
  ...
  fetch_evaluation_list_failed: 'Failed to load the evaluation list',
  click_to_analyze_exception: 'Click to analyze this exception',
  no_suitable_chart: 'No suitable visualization',
  resource_type_prefix: 'Resource type',
} as const;
