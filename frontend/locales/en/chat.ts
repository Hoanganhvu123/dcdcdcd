export const ChatEn = {
  ...
  date_month_day: '{{month}}/{{date}}',
  tab_render_result: 'Preview',
  ...
  popup_blocked: 'Browser blocked the popup, please allow and retry',
  select_file_to_preview: 'Select a file to view its content',
  no_files: 'No files',
  no_output: 'No output yet',
  select_step_title: 'Select a step to view details',
  select_step_subtitle: 'Click a step card on the left to show execution results',
  status_executing: 'Executing',
  status_ready: 'Ready',
  please_wait_result: 'Please wait, results will appear shortly',
  loading_script: 'Loading script...',
  waiting_for_result: 'Waiting for execution result...',
  output_count_one: '{{count}} output',
  output_count: '{{count}} outputs',
  artifact_item_count_one: '({{count}} item)',
  artifact_item_count: '({{count}} items)',
  // -- ObservationFormatter --
  obs_title: 'Data observation',
  obs_shape: 'Shape:',
  obs_shape_value: '{{rows}} rows x {{cols}} columns',
  obs_columns: 'Columns:',
  obs_dtypes: 'Data types',
  obs_column_info: 'Column info',
  obs_raw: 'Observation',
  // -- Home page toasts --
  file_not_downloadable: 'File is not downloadable yet',
  file_download_failed: 'File download failed',
  file_preview_failed: 'File preview failed',
  loading_example: 'Loading example...',
  load_example_failed: 'Failed to load example: ',
  load_history_failed: 'Failed to load conversation history',
  share_need_conversation: 'Start a conversation before sharing',
  share_link_copied: 'Share link copied to clipboard!',
  share_link_failed: 'Failed to create share link, please try again later',
