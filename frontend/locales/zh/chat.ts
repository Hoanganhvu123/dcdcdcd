...
export const ChatZh: Resources['translation'] = {
  ...
  weekday_fri: '星期五',
  weekday_sat: '星期六',
  date_month_day: '{{month}}月{{date}}日',
  tab_render_result: '渲染结果',
  tab_source_code: '源代码',
  ...
  sql_copied: 'SQL已复制到剪贴板',
  popup_blocked: '浏览器阻止了弹出窗口，请允许后重试',
  select_file_to_preview: '选择文件查看内容',
  no_files: '暂无文件',
  no_output: '暂无输出结果',
  select_step_title: '选择一个步骤查看详情',
  select_step_subtitle: '点击左侧的步骤卡片以显示执行结果',
  status_executing: '执行中',
  status_ready: '就绪',
  please_wait_result: '请稍候，结果即将显示',
  loading_script: '加载脚本中...',
  waiting_for_result: '等待执行结果...',
  output_count_one: '{{count}} 个输出',
  output_count: '{{count}} 个输出',
  artifact_item_count_one: '({{count}} 项)',
  artifact_item_count: '({{count}} 项)',
  // -- ObservationFormatter --
  obs_title: '数据观察',
  obs_shape: '数据规模：',
  obs_shape_value: '{{rows}} 行 × {{cols}} 列',
  obs_columns: '字段列表：',
  obs_dtypes: '数据类型',
  obs_column_info: '列信息',
  obs_raw: '观察结果',
  ...
  load_example_failed: '加载示例失败: ',
  load_history_failed: '加载历史对话失败',
  share_need_conversation: '请先开始一段对话再分享',
  share_link_copied: '分享链接已复制到剪贴板！',
  share_link_failed: '创建分享链接失败，请稍后重试',
  loading_history: '加载对话历史...',
} as const;
