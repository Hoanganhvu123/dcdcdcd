  ...
  return (
    <HoverCardTrigger asChild>
      <a
        ...
        className={cn(
          'bg-muted text-muted-foreground hover:bg-muted/80 hover:text-foreground inline-flex h-5 max-w-32 items-center gap-1 overflow-hidden rounded-full py-0 text-xs no-underline transition-colors duration-150',
          showFavicon ? 'pe-2 ps-1' : 'px-1.5',
          className
        )}
      >
        {showFavicon && (
