...
export const ChainOfThoughtContent = ({
  ...
  return (
    <CollapsibleContent
      className={cn(
        'text-popover-foreground overflow-hidden text-sm transition-all duration-150 ease-out data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down',
        className
      )}
      {...props}
    >
