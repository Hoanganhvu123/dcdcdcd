...
export const sendGetRequest = (url: string, qs?: { [key: string]: any }) => {
  ...
  return axios
    ...
    .then(res => res)
    .catch(err => {
      console.warn('[Request GET]', err?.message || err);
...
export const sendSpaceGetRequest = (url: string, qs?: { [key: string]: any }) => {
  ...
  return axios
    ...
    .then(res => res)
    .catch(err => {
      console.warn('[Request Space GET]', err?.message || err);
      return Promise.reject(err);
    });
};
...
export const sendPostRequest = (url: string, body?: any) => {
  ...
  return axios
    ...
    .then(res => res)
    .catch(err => {
      console.warn('[Request POST]', err?.message || err);
      return Promise.reject(err);
    });
};
...
export const sendSpacePostRequest = (url: string, body?: any) => {
  return axios
    ...
    .then(res => res)
    .catch(err => {
      console.warn('[Request Space POST]', err?.message || err);
      return Promise.reject(err);
    });
};
...
export const sendSpaceUploadPostRequest = (url: string, body?: any) => {
  return axios
    ...
    .then(res => res)
    .catch(err => {
      console.warn('[Request Upload]', err?.message || err);
      return Promise.reject(err);
    });
};
