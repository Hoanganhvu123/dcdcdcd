...
console.log('================================================================================');
console.log('🎬 DB-GPT KIMI-STYLE AGENT REPLAY & PLAYBACK SYSTEM: 4-TIER E2E TEST RUNNER (TS)');
console.log('================================================================================\n');

async function runTestFile(filePath: string, fileName: string): Promise<{ code: number | null; stdout: string; stderr: string; fileName: string; passCount: number }> {
...
async function main() {
  ...
  const tierResults: Array<{ tier: string; name: string; passed: boolean; testCount: number; minExpected: number }> = [];
